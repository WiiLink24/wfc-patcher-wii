...
{
    return vehicle >= EVehicle::S_STANDARD_KART &&
           vehicle <= EVehicle::L_PHANTOM;
}
...
{
    return course >= ECourse::MARIO_CIRCUIT &&
           course <= ECourse::GBA_SHY_GUY_BEACH;
}
