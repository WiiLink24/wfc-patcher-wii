...
public:
    ...
    {
        return m_gameMode == EGameMode::WIFI_FRIEND_VS ||
               m_gameMode == EGameMode::WIFI_PUBLIC_VS;
    }
    ...
    {
        [[gnu::longcall]] RaceConfigPlayer* getPlayer(
            RaceConfig * scenario, int index
        )
            AT(RMCXD_PORT(
...
private:
    ...
    static RaceConfigManager* s_instance AT(
        RMCXD_PORT(0x809BD728, 0x809B8F68, 0x809BC788, 0x809ABD68, 0x809BDFA8)
    );
};
