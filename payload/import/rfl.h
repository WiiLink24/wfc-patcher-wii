...
) AT(RMCXD_PORT(0x800C7DF0, 0x800C7D50, 0x800C7D10, 0x800C7E50, 0x800C7BC0)
...
) AT(RMCXD_PORT(0x800CA820, 0x800CA780, 0x800CA740, 0x800CA880, 0x800CA5F0)
     RMCXN_PORT(0x800B2710, 0x800B2680, 0x800B2660, 0x800B2780));

[[gnu::longcall]] u16 RFLiCalculateCRC(//
    const void* data, u32 size
) AT(RMCXD_PORT(0x800C78D0, 0x800C7830, 0x800C77F0, 0x800C7930, 0x800C76A0)
