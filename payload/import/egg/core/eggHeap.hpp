...
public:
    ...
    {
#if RMC
        [[gnu::longcall]] void* Alloc(std::size_t size, int alignment, Heap* heap)
            AT(RMCXD_PORT(0x80229814, 0x80229490, 0x80229734, 0x80229B88, 0x80229398));
    ...
    {
#if RMC
        [[gnu::longcall]] void Free(void* block, Heap* heap)
            AT(RMCXD_PORT(0x80229B84, 0x80229800, 0x80229AA4, 0x80229EF8, 0x80229708));
...
inline void* operator new(wwfc::std::size_t size, wwfc::EGG::Heap* heap, int alignment)
{
